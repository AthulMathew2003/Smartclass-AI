        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <header className="mb-12">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xs uppercase tracking-widest font-bold text-[var(--secondary)]">New Member</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight text-[var(--on-surface)] mb-2">Join Us</h1>
            <p className="text-base text-[var(--on-surface-variant)] leading-relaxed">Create an account to start your learning journey.</p>
          </header>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center gap-3 px-4 py-2">
              ...
              />
              <label htmlFor="terms" className="text-sm font-semibold tracking-wide text-[var(--on-surface-variant)]">I agree to the Terms of Service</label>
            </div>
          ...
          <div className="mt-12 space-y-6">
            <div className="flex items-center gap-4 text-[var(--outline-variant)]">
              ...
              <span className="text-xs uppercase tracking-widest font-bold">Or sign up with</span>
              <div className="h-[1px] flex-grow bg-[var(--outline-variant)]/30"></div>
            </div>
