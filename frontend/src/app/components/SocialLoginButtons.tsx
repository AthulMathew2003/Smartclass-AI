...
export default function SocialLoginButtons({ actionText = "continue with" }: { actionText?: string }) {
  return (
    <div className="mt-12 space-y-6">
      <div className="flex items-center gap-4 text-[var(--outline-variant)]">
        ...
        <span className="text-xs uppercase tracking-widest font-bold">Or {actionText}</span>
        <div className="h-[1px] flex-grow bg-[var(--outline-variant)]/30"></div>
      </div>
